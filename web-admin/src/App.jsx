  ...
  if (signalType === 'rtc_offer') {
   ...
   ;(async()=>{
    try {
     ...
     setCommunityActiveCall(prev => ({ ...(prev || {}), callId: signal.callId, mode, status: 'connected', peerUserId, isCaller: false }))
    } catch {}
   })()
   return
  }
