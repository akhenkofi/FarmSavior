...
function AppInner() {
 ...
 <button type='button' className='btn' onClick={()=>openCommunityCalls()}>Recent Calls</button>
 ...
 <div className='helper-text' style={{marginBottom:10}}>{communityInboxSection === 'calls' ? 'Recent call activity' : (communityMessageThreads.length ? `${communityMessageThreads.length} conversation${communityMessageThreads.length === 1 ? '' : 's'} ready` : 'No conversations yet - tap Message on a profile, search result, or post to start one.')}</div>
 <div className='tabs' style={{marginBottom:8}}>
  ...
  <button className={`tab ${communityInboxSection === 'calls' ? 'active' : ''}`} onClick={()=>setCommunityInboxSection('calls')}>Recent Calls</button>
 </div>
