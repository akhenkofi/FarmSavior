    ...
    <div className='authCard' style={{width:'min(1180px,98vw)'}}>
      ...
      <div className='three-col' style={{marginTop:10}}>
        ...
        <article className='panel'>
          ...
          <div className='list'>
            <div className='list-row'><span>{t('List Product','Publier un produit')}</span><button type='button' className='btn' onClick={()=>{ if (token) { goToAppSection('products'); return } setAuthMode('signup'); setAuthMsg(t('Create an account or log in to list a product.','Créez un compte ou connectez-vous pour publier un produit.')); }}>{t('Start','Démarrer')}</button></div>
            <div className='list-row'><span>{t('List Services','Publier des services')}</span><button type='button' className='btn' onClick={()=>{ if (token) { goToAppSection('services'); return } setAuthMode('signup'); setAuthMsg(t('Create an account or log in to list your services.','Créez un compte ou connectez-vous pour publier vos services.')); }}>{t('Start','Démarrer')}</button></div>
